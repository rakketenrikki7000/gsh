    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <Card title="Karte" kicker="Lageplan">
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900/60">
          <iframe
            title="Karte Gut Schluck Hauset"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2533.2622555323203!2d6.034!3d50.708!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNTHCsDQyJzI4LjgiTiA2wrAwMSc0Mi4zIkU!5e0!3m2!1sde!2sbe!4v1672938400000!5m2!1sde!2sbe"
            width="100%"
            height="280"
            allowFullScreen=""
            loading="lazy"
  ...
  <div className="relative isolate w-full px-4 pt-10 sm:px-6 lg:px-10">
    ...
    <Card title="Kontakt" kicker="Mitmachen">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div>
          <p className="text-sm text-slate-200/90">Heimspiele · Samstag 18:00 · Dorfstraße 12</p>
