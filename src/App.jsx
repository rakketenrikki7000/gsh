          ...
          {isAdmin && item.id ? (
            <div className="mt-4 flex flex-wrap gap-2">
              <Link
                ...
                className="rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-2 text-xs font-semibold text-emerald-100 transition hover:border-emerald-300/70 hover:bg-emerald-500/20"
              >
                Bearbeiten
              </Link>
              <button
    ...
    return (
      <div className="relative isolate w-full px-4 pt-10 sm:px-6 lg:px-10">
        <Card title="News nicht gefunden">
          ...
          <Link
            to="/news"
            className="mt-4 inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2 text-xs font-semibold text-white transition hover:border-emerald-300/60 hover:text-emerald-100"
          >
            Zurueck zu den News
          </Link>
        </Card>
      ...
      {isEditing ? (
        ...
        <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              <Link
                to="/news"
                className="inline-flex items-center justify-center rounded-full border border-white/10 px-4 py-2 text-xs font-semibold text-white transition hover:border-emerald-300/60 hover:text-emerald-100"
              >
                Zurueck zu den News
              </Link>
              {isAdmin ? (
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-full border border-emerald-400/40 bg-emerald-500/10 px-4 py-2 text-xs font-semibold text-emerald-100 transition hover:border-emerald-300/70 hover:bg-emerald-500/20"
                >
                  Bearbeiten
                </button>
              ) : null}
